                        ...
                        else
                        {
                            ...
                            else if (the_params.the_format_tech_prod_id_list[i].tp_id == 30)
                            {
                                ...
                                else
                                {
                                    ...
                                    identifyDevice(the_params.username_ad, the_params.password_ad, soc, the_params.the_serial_number_list[i], the_params.the_format_tech_prod_id_list[i].tp_id, the_params.the_format_tech_prod_id_list[i].agd_id, antenna.ModelId.Value);
                                }
                            }
                            ...
                            else if (the_params.the_format_tech_prod_id_list[i].tp_id == 393 || the_params.the_format_tech_prod_id_list[i].tp_id == 4)
                            {
                                ...
                                else
                                {
                                    ...
                                    identifyDevice(the_params.username_ad, the_params.password_ad, soc, the_params.the_serial_number_list[i], the_params.the_format_tech_prod_id_list[i].tp_id, the_params.the_format_tech_prod_id_list[i].agd_id, lnb.ModelId.Value);
                                }
